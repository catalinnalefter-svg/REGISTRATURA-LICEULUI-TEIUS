...
import { Plus, Hash, Calendar, Search, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f9fa] p-8 font-sans antialiased text-slate-900">
      <header className="flex items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="bg-white border px-3 py-1 rounded-lg text-sm font-semibold text-slate-500 flex items-center gap-2 text-center">
      ...
      <div className="flex flex-wrap gap-3 mb-10 text-white">
        <button className="bg-[#22c55e] px-6 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-green-100 hover:opacity-90 transition-all">
          <Plus size={20} /> Adaugă document intrare / intern
        </button>
        <button className="bg-[#007bff] px-6 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-blue-100 hover:opacity-90 transition-all">
          <Plus size={20} /> Adaugă document ieșire
        </button>
        <button className="bg-[#f39c12] px-6 py-3 rounded-2xl font-bold flex items-center gap-2 shadow-lg shadow-orange-100 hover:opacity-90 transition-all">
