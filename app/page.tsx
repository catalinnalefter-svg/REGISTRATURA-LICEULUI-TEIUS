  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] p-8 font-sans antialiased text-slate-900">
      ...
      <div className="flex flex-wrap gap-3 mb-10 text-white font-bold">
        <button className="bg-[#22c55e] px-6 py-3 rounded-2xl flex items-center gap-2 shadow-lg hover:opacity-90">
          <Plus size={20} /> Adaugă document intrare / intern
        </button>
        <button className="bg-[#007bff] px-6 py-3 rounded-2xl flex items-center gap-2 shadow-lg hover:opacity-90">
          <Plus size={20} /> Adaugă document ieșire
        </button>
        <button className="bg-[#f39c12] px-6 py-3 rounded-2xl flex items-center gap-2 shadow-lg hover:opacity-90">
